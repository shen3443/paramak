...
def main():
    ...
    # this makes a banana shape with spline edges and rotates it to make a solid
    ...
    rotated_circle = paramak.RotateCircleShape(points=[(50, 0)], radius=5, workplane="XZ")
    ...
    # this makes a banana shape with spline edges and extrudes it to make a solid
    ...
    # this makes a shape with straight, spline and circular edges and extrudes it to make a solid
    ...
    extruded_circle = paramak.ExtrudeCircleShape(points=[(20, 0)], radius=20, distance=200)
    ...
    # this makes a banana shape with straight edges and sweeps it along a spline to make a solid
    ...
    # this makes a shape with straight, spline and circular edges and sweeps it along a spline to make a solid
