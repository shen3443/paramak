...
class SweepMixedShape(Shape):
    """Sweeps a 2D shape created from points connected with straight, spline or circular
       ...
       Args:
           points (list of tuples): a list of XY, YZ or XZ coordinates connected by straight,
               spline or circular connections which define the 2D shape to be swept. The coordinates
               are defined with respect to origins at the first and last points of the spline path
