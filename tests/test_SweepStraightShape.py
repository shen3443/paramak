...
class test_object_properties(unittest.TestCase):
    ...
    def test_relative_solid_volumes(self):
        """creates swept solids with different cross-sections and paths and checks that
    ...
    def test_cut_volume(self):
        """creates two swept solids and cuts one from the other and checks that the volume
                of the resultant solid is correct"""
    ...
    def test_workplane_check(self):
        """creates a SweepStraightShape with workplane = path_workplane and checks that a ValueError is raised"""
    ...
    def test_azimuth_placement_angle(self):
        """creates SweepStraightShape solids with single and multiple azimuth
            placement angles and checks the volumes are correct"""
